...
| `The contents of fo:instream-foreign-object line 1 exceed the available area in the inline-progression direction by x millipoints. (See position y:z)`                               | ???                                                                                                                                                                                                              | ???                               |
| `The contents of fo:block line 1 exceed the available area in the inline-progression direction by x millipoints. (See position y:z)`                                                 | ???                                                                                                                                                                                                              | ???                               |
