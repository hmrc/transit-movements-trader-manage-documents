...
object Table1ViewModel {
  ...
  def apply(ie029: CC029CType): Table1ViewModel = {
    ...
    new Table1ViewModel(
      ...
      hotPContactPerson = ie029.HolderOfTheTransitProcedure.ContactPerson.map(_.asString).orElseBlank.adjustFor2NarrowLines,
      ...
      representativeContactPerson = ie029.Representative.flatMap(_.ContactPerson.map(_.asString)).orElseBlank.take45,
      ...
      carrierContactPerson = ie029.Consignment.Carrier.flatMap(_.ContactPerson.map(_.asString)).orElseBlank.take45,
