...
object ConsignmentItemViewModel {
  ...
  def apply(ie015: CC015CType, houseConsignment: CUSTOM_HouseConsignmentType03, consignmentItem: CUSTOM_ConsignmentItemType03): ConsignmentItemViewModel =
    new ConsignmentItemViewModel(
      ...
      supplyChainActorId = consignmentItem.AdditionalSupplyChainActor.map(_.identificationNumber).takeSample,
      ...
      departureTransportMeans = houseConsignment.DepartureTransportMeans.map(_.asSlashSeparatedString).takeSample,
