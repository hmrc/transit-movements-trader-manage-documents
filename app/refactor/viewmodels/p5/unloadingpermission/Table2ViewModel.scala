...
object Table2ViewModel {
  ...
  def apply(ie043: CC043CType): Table2ViewModel =
    new Table2ViewModel(
      ...
      departureTransportMeans = ie043.Consignment.fold[Seq[String]](Nil)(_.DepartureTransportMeans.map(_.asString)).semiColonSeparate,
