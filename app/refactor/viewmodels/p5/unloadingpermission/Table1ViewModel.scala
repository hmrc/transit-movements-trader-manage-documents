...
case class Table1ViewModel(
  ...
  departureTransportMeans: Seq[(String, Int)],
  container: String,
...
object Table1ViewModel {
  ...
  def apply(ie043: CC043CType): Table1ViewModel =
    new Table1ViewModel(
      ...
      departureTransportMeans = ie043.Consignment.fold[Seq[String]](Nil)(_.DepartureTransportMeans.map(_.asString)).zipWithIndex,
