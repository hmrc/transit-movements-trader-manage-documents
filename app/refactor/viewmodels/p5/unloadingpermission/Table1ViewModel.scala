...
object Table1ViewModel {
  ...
  def apply(ie043: CC043CType): Table1ViewModel =
    new Table1ViewModel(
      ...
      departureTransportMeans = ie043.Consignment.fold[Seq[String]](Nil)(_.DepartureTransportMeans.map(_.asString)).separateWithSemiColon,
      container = ie043.Consignment.map(_.containerIndicator.asString).orElseBlank,
      transportEquipment = ie043.Consignment.fold[Seq[String]](Nil)(_.TransportEquipment.map(_.asString)).separateWithSemiColon,
      seals = ie043.Consignment.fold[Seq[String]](Nil)(_.TransportEquipment.flatMap(_.Seal).map(_.asString)).separateWithSemiColon,
      previousDocument = ie043.Consignment.fold[Seq[String]](Nil)(_.PreviousDocument.map(_.asString)).separateWithSemiColon,
      transportDocument = ie043.Consignment.fold[Seq[String]](Nil)(_.TransportDocument.map(_.asString)).separateWithSemiColon,
      supportingDocument = ie043.Consignment.fold[Seq[String]](Nil)(_.SupportingDocument.map(_.asString)).separateWithSemiColon,
      additionalReference = ie043.Consignment.fold[Seq[String]](Nil)(_.AdditionalReference.map(_.asString)).separateWithSemiColon,
      additionalInformation = ie043.Consignment.fold[Seq[String]](Nil)(_.AdditionalInformation.map(_.asString)).separateWithSemiColon,
