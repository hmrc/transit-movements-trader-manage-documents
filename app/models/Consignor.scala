...
object Consignor {
  ...
  implicit lazy val xmlReader: XmlReader[Consignor] =
    xmlReaderGoodsLevel.or(xmlReaderHeaderLevel)

  private val xmlReaderGoodsLevel: XmlReader[Consignor] = {
    (
  ...
  private val xmlReaderHeaderLevel: XmlReader[Consignor] = {
    (
