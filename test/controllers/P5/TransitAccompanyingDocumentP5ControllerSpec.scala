...
//import cats.data._
//import generators.P5ModelGenerators
//import models.P5.departure.{IE015, IE015MessageData}
...
//
//class TransitAccompanyingDocumentP5ControllerSpec extends SpecBase with P5ModelGenerators with ScalaCheckPropertyChecks with BeforeAndAfterEach {
//
...
//
//  private val mockService = mock[DepartureMessageP5Service]
//
//  "get" - {
//
...
//        .overrides(
//          bind[DepartureMessageP5Service].toInstance(mockService)
//        )
//
...
//          ie015 =>
//            when(mockService.getDeclarationData(any(), any())(any(), any()))
...
//
//        when(mockService.getDeclarationData(any(), any())(any(), any()))
//          .thenReturn(Future.successful(IE015(IE015MessageData(IE0)))
//
